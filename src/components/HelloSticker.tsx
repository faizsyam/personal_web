...
export default function HelloSticker() {
  ...
  return (
    <div className="relative inline-block w-full max-w-[240px] sm:max-w-[270px] mb-6 mt-2 select-none">
      {/* Decorative physical drop shadow behind the sticker to represent a peeling corner */}
      <div 
      ...
      <motion.div
        ...
        className="relative w-full aspect-[16/10] rounded-xl bg-[#FCFBF8] border-[1.2px] border-primary/10 overflow-hidden select-none cursor-grab active:cursor-grabbing flex flex-col items-stretch"
        style={{
      ...
      >
        ...
        {/* Vintage Paper Crease lines - adding highly realistic physical depth */}
